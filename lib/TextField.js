...
export default class TextField extends Component {
  ...
  render() {
    ...
    let inputHeight = this.state.height;
    inputHeight = inputHeight && height && inputHeight > height ? height : inputHeight;
    return (
      <View style={[dense ? styles.denseWrapper : styles.wrapper, inputHeight ? {height: inputHeight + 30}: {}, wrapperStyle]} ref="wrapper">
        <TextInput
          style={[dense ? styles.denseTextInput : styles.textInput, {
            ...
            color: textBlurColor
          } : {}, inputStyle,  inputHeight ? {height: inputHeight} : {}]}
          multiline={multiline}
          onFocus={() => {
